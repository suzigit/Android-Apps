...
public class ActivityLoaderActivity extends Activity {
	...
	private void startExplicitActivation() {
		...
		// TODO - Create a new intent to launch the ExplicitlyLoadedActivity class - OK
		Intent explicitIntent = new Intent (ActivityLoaderActivity.this, ExplicitlyLoadedActivity.class);

		
		// TODO - Start an Activity using that intent and the request code defined above - OK
	...
	private void startImplicitActivation() {
		...
		// TODO - Create a base intent for viewing a URL  - ok
		// (HINT:  second parameter uses Uri.parse())
        Intent baseIntent = new Intent(
                android.content.Intent.ACTION_VIEW,
                Uri.parse(URL));
		
		// TODO - Create a chooser intent, for choosing which Activity - ok
		...
		// TODO - Start the chooser Activity, using the chooser intent  - ok
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK
            ...
            String text = data.getStringExtra("userInputToDisplay");
