	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		cancelButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				// TODO - Indicate result and finish - ok
		...
		// TODO - Set up OnClickListener for the Reset Button - ok
		...
		resetButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				// TODO - Reset data to default values - ok
                mTitleText.setText("");
		...
		submitButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				// TODO - Get the current Priority - ok
				Priority priority = getPriority();

				// TODO - Get the current Status - ok
				Status status = getStatus();

				// TODO - Get the current ToDoItem Title - ok
				...
				// TODO - return data Intent and finish - ok
