...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        // TODO: Create new DownloaderTask that "downloads" data--ok
        DownloaderTask dt = new DownloaderTask();


        // TODO: Retrieve arguments from DownloaderTaskFragment - ok
        // Prepare them for use with DownloaderTask.
        Bundle bundle = this.getArguments();
        ArrayList<Integer> idsAsList = bundle.getIntegerArrayList("friends");
        Integer[] ids = new Integer[idsAsList.size()];
        for (int i=0; i<ids.length; i++) {
            ids[i]=idsAsList.get(i);
        }

        // TODO: Start the DownloaderTask - ok
        dt.execute(ids);
	...
	// TODO: Implement an AsyncTask subclass called DownLoaderTask. - ok
	...
	// the hosting Activity using the DownloadFinishedListener interface.
	 ...
	 public class DownloaderTask extends AsyncTask<Integer, Void, String[]> {
         ...
         protected String[] doInBackground(Integer... resourceIDS) {
             String[] tweets = this.downloadTweets(resourceIDS);
             return tweets;
         }
         ...
         // TODO: Uncomment this helper method - ok
			...
			mContext.sendOrderedBroadcast(new Intent(
					...
					new BroadcastReceiver() {
						...
						public void onReceive(Context context, Intent intent) {
							...
							// TODO: Check whether or not the MainActivity --ok
							// received the broadcast
							if (this.getResultCode()!=MainActivity.IS_ALIVE) {

                                // TODO: If not, create a PendingIntent using - ok
								// the
								// restartMainActivityIntent and set its flags
								// to FLAG_UPDATE_CURRENT - ok
                                final PendingIntent restartMainActivityPendingIntent =
								...
								// TODO: Set the notification View's text to - ok
								...
								// TODO: Use the Notification.Builder class to - ok
